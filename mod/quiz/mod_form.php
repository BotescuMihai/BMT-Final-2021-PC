...
Botescu-s-Moodle-Team/mod/quiz/mod_form.php /
@RobertBeze
RobertBeze primul commit
Latest commit cb6be12 on Mar 26
History
1 contributor
We found potential security vulnerabilities in your dependencies.

Only the owner of this repository can see this message.
executable file 683 lines (586 sloc) 31 KB
<?php
...
class mod_quiz_mod_form extends moodleform_mod {
    ...
    protected function definition() {
        ...
        // Time limit.
       // $mform->addElement('duration', 'timelimit', array('0' => get_string()),
